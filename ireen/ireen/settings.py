...
# Support environment-based CSRF origins for production
if os.getenv('CSRF_TRUSTED_ORIGINS_ENV'):
    CSRF_TRUSTED_ORIGINS.extend(os.getenv('CSRF_TRUSTED_ORIGINS_ENV', '').split(','))
